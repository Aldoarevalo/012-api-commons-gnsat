...
@AllArgsConstructor
@Builder
@Table(name = "WMS_DETRECADV", schema = "GNSAT")
@IdClass(DetrecadvId.class)
public class Detrecadv {
    ...
    @Column(name = "WMS_SKU", length = 50)
    private String wmsSku;

    @Column(name = "WMS_RECEIPTLINENUMBER", length = 5)
    private String wmsReceiptlinenumber;

    @Column(name = "WMS_QTYRECEIVED")
    private BigDecimal wmsQtyreceived;

    @Column(name = "WMS_UOM", length = 10)
    private String wmsUom;
    ...
    @Column(name = "WMS_EXT_UDF_FLOAT1", precision = 22, scale = 5)
    private BigDecimal wmsExtUdfFloat1;

    @Column(name = "WMS_EXT_UDF_FLOAT2", precision = 22, scale = 5)
    private BigDecimal wmsExtUdfFloat2;

    @Column(name = "WMS_EXT_UDF_FLOAT3", precision = 22, scale = 5)
    private BigDecimal wmsExtUdfFloat3;

    @Column(name = "WMS_EXT_UDF_FLOAT4", precision = 22, scale = 5)
    private BigDecimal wmsExtUdfFloat4;

    @Column(name = "WMS_EXT_UDF_FLOAT5", precision = 22, scale = 5)
    ...
    @Column(name = "WMS_LOTTABLE04")
    @Temporal(TemporalType.DATE)
    private Date wmsLottable04;

    @Column(name = "WMS_LOTTABLE05")
    @Temporal(TemporalType.DATE)
    private Date wmsLottable05;
    ...
    public static class MensajeRespuesta {
        ...
        private List<Detrecadv> detrecadvs;
    }
