...
@AllArgsConstructor
@Builder
@Table(name = "WMS_RECADV", schema = "GNSAT")
@IdClass(RecadvId.class)
public class Recadv{
    @Id
    ...
    @Column(name = "WMS_EXPECTEDRECEIPTDATE")
    @Temporal(TemporalType.TIMESTAMP)
    private Date wmsExpectedreceiptdate;
    ...
    @Column(name = "WMS_SUPPLIERCODE", length = 15)
    ...
    @Column(name = "WMS_CLOSEDDATE")
    @Temporal(TemporalType.TIMESTAMP)
    private Date wmsCloseddate;
